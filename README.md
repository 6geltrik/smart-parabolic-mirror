...
Η μέγιστη απόδοση επιτυγχάνεται με την χρήση του μικροεπεξεργαστή arduino, τον οποίο προγραμματίζουμε έτσι ώστε η συσκευή μας να παρακολουθεί τον ήλιο καθ όλη την διάρκεια της ημέρας, με την βοήθεια φωτοκυττάρων.
...
Στην συνέχεια κατασκευάζουμε τους δύο άξονες περιστροφής με τις τροχαλίες και τα συνδέουμε όλα στην βάση.
...
Το πρόγραμμα ειναι εδω: https://github.com/6geltrik/smart-parabolic-mirror/blob/master/Program
