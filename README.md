...
Η μέγιστη απόδοση επιτυγχάνεται με την χρήση του μικροεπεξεργαστή arduino, τον οποίο προγραμματίζουμε έτσι ώστε η συσκευή μας να παρακολουθεί τον ήλιο καθ όλη την διάρκεια της ημέρας, με την βοήθεια φωτοκυτάρων.
