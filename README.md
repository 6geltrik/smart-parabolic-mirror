...
Αρχικά κολλήσαμε 3 φωτοβολταϊκά πάνελ σε σειρά πάνω στο κάτοπτρο ώστε να έχουμε συνολικά 18V. Μετά κατασκευάσαμε την πλακέτα ηλεκτρονικών εξαρτημάτων η οποία δέχεται τα 18V και έχει έξοδο 12V για φόρτιση της μπαταρίας.
